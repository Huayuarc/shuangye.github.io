...
static BOOL pm_isTargetProcessForHooking(void) {
    // 只要是支持120Hz设备，全部进程启用Hook，不再做路径过滤
    return pm_deviceSupports120Hz();
}
...
@interface BKDisplayBrightnessService : NSObject
...
// ============================================================
// CAFrameRateArbitrator — 底层帧率仲裁拦截
// ============================================================
...
// ============================================================
// BKDisplayBrightnessService — backboardd 系统守护降频拦截
// ============================================================
%hook BKDisplayBrightnessService
- (void)setMaximumRefreshRate:(double)rate {
    if (pm_deviceSupports120Hz()) {
        %orig(120.0);
    } else {
