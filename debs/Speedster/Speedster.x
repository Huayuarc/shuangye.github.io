...
static BOOL g_cowHideDockBackground = NO;
static BOOL g_cowHideHomeBar = NO;
static BOOL g_cowHideFolderIconBackground = NO;
static BOOL g_cowDisableFolderBlur = NO;
static BOOL g_cowHideAppLibraryPodBackground = NO;
static BOOL g_cowDisableSwitcherBlur = NO;
static BOOL g_cowHideCCModuleBackground = NO;
static BOOL g_cowHideNotificationBackground = NO;
static BOOL g_cowHideNotificationShadow = NO;
static BOOL g_cowHideAppLibrarySearchBackground = NO;
static BOOL g_cowHideWidgetConfigurationBackground = NO;
static BOOL g_cowHideSpotlightBackground = NO;
static BOOL g_cowHidePasscodeBackground = NO;
static BOOL g_cowHideLockIcon = NO;
static BOOL g_cowHideNotificationAvatarBackground = NO;
static BOOL g_cowHideMediaPlayerBackground = NO;
static BOOL g_cowHideCCSliderGlyphs = NO;
static BOOL g_cowHideMediaTransportButtons = NO;
static BOOL g_cowHideDeleteButtons = NO;

// iOS 16 UIStatusBarServer 功能
static BOOL g_statusBarLiquidDetection = NO;
static BOOL g_statusBarOverrideEnabled = NO;
static int32_t g_statusBarOverrideValue = 64;
static BOOL g_statusBarLiquidDetectionApplied = NO;
static BOOL g_statusBarOverrideApplied = NO;
static int32_t g_statusBarAppliedOverrideValue = 0;
...
// ========== FiveIconDock 移植 + 捏合控制数量 ==========
static BOOL g_dockPinchControl = NO;    // 捏合控制数量开关(兼作多图标总开关)
static NSInteger g_dockIconCount = 5;   // 当前生效的 Dock 图标数量
static NSInteger g_dockDefaultCount = 5; // 面板设置的默认数量
static const NSInteger kDockMinCount = 4;
static const NSInteger kDockMaxCount = 8;
...
static void sdr_refreshStatusBarOverrides(void);
...
void preferencesthings(){ //pref starts to look THICC
    ...
    g_cowHideDockBackground = (prefs && [prefs objectForKey:@"cowHideDockBackground"] ? [[prefs valueForKey:@"cowHideDockBackground"] boolValue] : NO );
    g_cowHideHomeBar = (prefs && [prefs objectForKey:@"cowHideHomeBar"] ? [[prefs valueForKey:@"cowHideHomeBar"] boolValue] : NO );
    g_cowHideFolderIconBackground = (prefs && [prefs objectForKey:@"cowHideFolderIconBackground"] ? [[prefs valueForKey:@"cowHideFolderIconBackground"] boolValue] : NO );
    g_cowDisableFolderBlur = (prefs && [prefs objectForKey:@"cowDisableFolderBlur"] ? [[prefs valueForKey:@"cowDisableFolderBlur"] boolValue] : NO );
    g_cowHideAppLibraryPodBackground = (prefs && [prefs objectForKey:@"cowHideAppLibraryPodBackground"] ? [[prefs valueForKey:@"cowHideAppLibraryPodBackground"] boolValue] : NO );
    g_cowDisableSwitcherBlur = (prefs && [prefs objectForKey:@"cowDisableSwitcherBlur"] ? [[prefs valueForKey:@"cowDisableSwitcherBlur"] boolValue] : NO );
    g_cowHideCCModuleBackground = (prefs && [prefs objectForKey:@"cowHideCCModuleBackground"] ? [[prefs valueForKey:@"cowHideCCModuleBackground"] boolValue] : NO );
    ...
    g_cowHideAppLibrarySearchBackground = (prefs && [prefs objectForKey:@"cowHideAppLibrarySearchBackground"] ? [[prefs valueForKey:@"cowHideAppLibrarySearchBackground"] boolValue] : NO );
    g_cowHideWidgetConfigurationBackground = (prefs && [prefs objectForKey:@"cowHideWidgetConfigurationBackground"] ? [[prefs valueForKey:@"cowHideWidgetConfigurationBackground"] boolValue] : NO );
    g_cowHideSpotlightBackground = (prefs && [prefs objectForKey:@"cowHideSpotlightBackground"] ? [[prefs valueForKey:@"cowHideSpotlightBackground"] boolValue] : NO );
    g_cowHidePasscodeBackground = (prefs && [prefs objectForKey:@"cowHidePasscodeBackground"] ? [[prefs valueForKey:@"cowHidePasscodeBackground"] boolValue] : NO );
    g_cowHideLockIcon = (prefs && [prefs objectForKey:@"cowHideLockIcon"] ? [[prefs valueForKey:@"cowHideLockIcon"] boolValue] : NO );
    g_cowHideNotificationAvatarBackground = (prefs && [prefs objectForKey:@"cowHideNotificationAvatarBackground"] ? [[prefs valueForKey:@"cowHideNotificationAvatarBackground"] boolValue] : NO );
    g_cowHideMediaPlayerBackground = (prefs && [prefs objectForKey:@"cowHideMediaPlayerBackground"] ? [[prefs valueForKey:@"cowHideMediaPlayerBackground"] boolValue] : NO );
    g_cowHideCCSliderGlyphs = (prefs && [prefs objectForKey:@"cowHideCCSliderGlyphs"] ? [[prefs valueForKey:@"cowHideCCSliderGlyphs"] boolValue] : NO );
    g_cowHideMediaTransportButtons = (prefs && [prefs objectForKey:@"cowHideMediaTransportButtons"] ? [[prefs valueForKey:@"cowHideMediaTransportButtons"] boolValue] : NO );
    g_cowHideDeleteButtons = (prefs && [prefs objectForKey:@"cowHideDeleteButtons"] ? [[prefs valueForKey:@"cowHideDeleteButtons"] boolValue] : NO );
    g_statusBarLiquidDetection = (prefs && [prefs objectForKey:@"statusBarLiquidDetection"] ? [[prefs valueForKey:@"statusBarLiquidDetection"] boolValue] : NO );
    g_statusBarOverrideEnabled = (prefs && [prefs objectForKey:@"statusBarOverrideEnabled"] ? [[prefs valueForKey:@"statusBarOverrideEnabled"] boolValue] : NO );
    long long statusBarOverrideValue = (prefs && [prefs objectForKey:@"statusBarOverrideValue"] ? [[prefs valueForKey:@"statusBarOverrideValue"] longLongValue] : 64 );
    if (statusBarOverrideValue < INT32_MIN || statusBarOverrideValue > INT32_MAX) statusBarOverrideValue = 64;
    g_statusBarOverrideValue = (int32_t)statusBarOverrideValue;
    // ========== 控制中心手势位置偏好读取 ==========
    ...
    // ========== FiveIconDock / 捏合控制偏好 ==========
    g_dockPinchControl = (prefs && [prefs objectForKey:@"dockPinchControl"] ? [[prefs valueForKey:@"dockPinchControl"] boolValue] : NO );
    g_dockDefaultCount = (prefs && [prefs objectForKey:@"dockIconCount"] ? [[prefs valueForKey:@"dockIconCount"] integerValue] : 5 );
    if (g_dockDefaultCount < kDockMinCount) g_dockDefaultCount = kDockMinCount;
    if (g_dockDefaultCount > kDockMaxCount) g_dockDefaultCount = kDockMaxCount;
    // 捏合控制开启时以保存的数量生效;关闭时恢复标准 4 图标
    g_dockIconCount = g_dockPinchControl ? g_dockDefaultCount : 4;
    ...
    g_hideHomeIconLabels = (prefs && [prefs objectForKey:@"hideHomeIconLabels"] ? [[prefs valueForKey:@"hideHomeIconLabels"] boolValue] : NO );
    ...
    g_appSwitcherGrid = (prefs && [prefs objectForKey:@"appSwitcherGrid"] ? [[prefs valueForKey:@"appSwitcherGrid"] boolValue] : NO );
...
static void sdr_applyDockAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"backgroundView",
        @"backgroundImageView",
        @"accessibilityBackgroundView",
        @"backgroundEffectView",
        @"materialView"
    ], g_cowHideDockBackground);
}
...
static void sdr_applyFolderControllerAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"blurView",
        @"blurViewSnapshot",
        @"backgroundView",
        @"materialView"
    ], g_cowDisableFolderBlur);
}

static void sdr_applyControlCenterModuleAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"moduleMaterialView",
        @"backgroundView",
        @"materialView"
    ], g_cowHideCCModuleBackground);
}
...
static void sdr_applyWidgetConfigurationAppearance(id object) {
    sdr_setKeyedViewsSuppressed(object, @[
        @"backgroundFilterView",
        @"backgroundMaterialView",
        @"backgroundStackMatchingView",
        @"backgroundDimmingView"
    ], g_cowHideWidgetConfigurationBackground);
}

static void sdr_applySpotlightAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"materialView",
        @"topBlurView",
        @"platterBackgroundView"
    ], g_cowHideSpotlightBackground);
    if ([NSStringFromClass(view.class) isEqualToString:@"SPUIHeaderBlurView"]) {
        sdr_setViewSuppressed(view, g_cowHideSpotlightBackground);
    }
}

static void sdr_applyPasscodeBackgroundAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"materialView",
    ...
    ], g_cowHidePasscodeBackground);
}

static void sdr_applyNotificationAvatarAppearance(UIView *view) {
    sdr_setViewSuppressed(sdr_viewForKey(view, @"backgroundMaterialView"), g_cowHideNotificationAvatarBackground);
}

static void sdr_applyMediaPlayerMaterialAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"backgroundView",
        @"highlightView",
        @"materialView"
    ], g_cowHideMediaPlayerBackground);
}

static void sdr_applyControlCenterSliderAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"activeGlyphView",
        @"compensatingGlyphView",
        @"glyphImageView",
        @"glyphPackageView"
    ], g_cowHideCCSliderGlyphs);
}

static void sdr_applyMediaTransportAppearance(UIView *view) {
    sdr_setKeyedViewsSuppressed(view, @[
        @"centerButton",
        @"middleButton",
        @"leadingButton",
        @"leftButton",
        @"rightButton"
    ], g_cowHideMediaTransportButtons);
}

static void sdr_applyCowabungaAppearanceToView(UIView *view) {
    if (!view) return;
    NSString *className = NSStringFromClass(view.class);
    if ([className isEqualToString:@"SBDockView"]) {
        sdr_applyDockAppearance(view);
    } else if ([className isEqualToString:@"SBHomeGrabberView"]) {
        ...
        sdr_setViewSuppressed(view, g_cowHideFolderIconBackground);
    } else if ([className isEqualToString:@"SBFolderControllerBackgroundView"]) {
        sdr_applyFolderControllerAppearance(view);
    } else if ([className isEqualToString:@"SBHLibraryCategoryPodBackgroundView"] || [className isEqualToString:@"_SBHLibraryCategoryStackViewBackgroundView"]) {
        sdr_setViewSuppressed(view, g_cowHideAppLibraryPodBackground);
    } else if ([className isEqualToString:@"SBHomeScreenBackdropView"]) {
        sdr_setViewSuppressed(view, g_cowDisableSwitcherBlur);
    } else if ([className isEqualToString:@"CCUIContentModuleContentContainerView"]) {
        sdr_applyControlCenterModuleAppearance(view);
    ...
    } else if ([className isEqualToString:@"SBHLibrarySearchSimplifiedBackgroundView"] ||
               [className isEqualToString:@"SBHLibrarySearchBackgroundView"]) {
        sdr_setViewSuppressed(view, g_cowHideAppLibrarySearchBackground);
    } else if ([className isEqualToString:@"SBHStackConfigurationApertureView"]) {
        sdr_applyWidgetConfigurationAppearance(view);
    } else if ([className isEqualToString:@"SBHStackConfigurationBackgroundDimmingView"]) {
        sdr_setViewSuppressed(view, g_cowHideWidgetConfigurationBackground);
    } else if ([className isEqualToString:@"SBHWidgetSearchBarBackgroundView"]) {
        sdr_setViewSuppressed(view, g_cowHideWidgetConfigurationBackground);
    } else if ([className isEqualToString:@"SBSearchBackdropView"] ||
               [className isEqualToString:@"SPUIHeaderBlurView"]) {
        sdr_applySpotlightAppearance(view);
    } else if ([className isEqualToString:@"CSPasscodeBackgroundView"]) {
        sdr_applyPasscodeBackgroundAppearance(view);
    } else if ([className isEqualToString:@"SBUIProudLockIconView"]) {
        sdr_setViewSuppressed(view, g_cowHideLockIcon);
    } else if ([className isEqualToString:@"NCAvatarView"]) {
        sdr_applyNotificationAvatarAppearance(view);
    } else if ([className isEqualToString:@"MediaControlsMaterialView"]) {
        sdr_applyMediaPlayerMaterialAppearance(view);
    } else if ([className isEqualToString:@"CCUIBaseSliderView"] ||
               [className isEqualToString:@"CCUIContinuousSliderView"] ||
               [className isEqualToString:@"CCUIModuleSliderView"]) {
        sdr_applyControlCenterSliderAppearance(view);
    } else if ([className isEqualToString:@"MRUNowPlayingTransportControlsView"]) {
        sdr_applyMediaTransportAppearance(view);
    } else if ([className isEqualToString:@"SBCloseBoxView"] ||
               [className isEqualToString:@"SBMinusCloseBoxView"] ||
               [className isEqualToString:@"SBXCloseBoxView"]) {
        sdr_setViewSuppressed(view, g_cowHideDeleteButtons);
    }
...
static BOOL sdr_sendStatusBarServerValue(const char *selectorName, int32_t value) {
    Class serverClass = NSClassFromString(@"UIStatusBarServer");
    if (!serverClass || !selectorName) return NO;
    SEL selector = sel_registerName(selectorName);
    if (![serverClass respondsToSelector:selector]) return NO;
    ((void (*)(id, SEL, int32_t))objc_msgSend)(serverClass, selector, value);
    return YES;
}
...
static void sdr_refreshStatusBarOverrides(void) {
    ...
    const int32_t liquidDetectionItem = 40;
    if (g_statusBarLiquidDetection != g_statusBarLiquidDetectionApplied) {
        const char *selector = g_statusBarLiquidDetection ? "addStatusBarItem:" : "removeStatusBarItem:";
        if (sdr_sendStatusBarServerValue(selector, liquidDetectionItem)) {
            g_statusBarLiquidDetectionApplied = g_statusBarLiquidDetection;
        }
    }

    if (g_statusBarOverrideApplied &&
        (!g_statusBarOverrideEnabled || g_statusBarAppliedOverrideValue != g_statusBarOverrideValue)) {
        if (sdr_sendStatusBarServerValue("removeStyleOverrides:", g_statusBarAppliedOverrideValue)) {
            g_statusBarOverrideApplied = NO;
        }
    }

    if (g_statusBarOverrideEnabled &&
        (!g_statusBarOverrideApplied || g_statusBarAppliedOverrideValue != g_statusBarOverrideValue)) {
        if (sdr_sendStatusBarServerValue("addStyleOverrides:", g_statusBarOverrideValue)) {
            g_statusBarAppliedOverrideValue = g_statusBarOverrideValue;
            g_statusBarOverrideApplied = YES;
        }
    }
}
...
- (void)layoutSubviews {
    %orig;
    sdr_applyDockAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideFolderIconBackground);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyFolderControllerAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideAppLibraryPodBackground);
}
%end

%hook _SBHLibraryCategoryStackViewBackgroundView
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideAppLibraryPodBackground);
}
...
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowDisableSwitcherBlur);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyControlCenterModuleAppearance((UIView *)self);
}
%end
...
%hook SBHLibrarySearchSimplifiedBackgroundView
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideAppLibrarySearchBackground);
}
%end

%hook SBHLibrarySearchBackgroundView
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideAppLibrarySearchBackground);
}
...
%hook SBHWidgetSearchBarBackgroundView
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideWidgetConfigurationBackground);
}
%end

%hook SBHStackConfigurationApertureView
- (void)layoutSubviews {
    %orig;
    sdr_applyWidgetConfigurationAppearance(self);
}
%end

%hook SBHStackConfigurationBackgroundDimmingView
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideWidgetConfigurationBackground);
}
...
%hook SBHStackConfigurationViewController
...
- (void)layoutSubviews {
    %orig;
    sdr_applySpotlightAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyPasscodeBackgroundAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideLockIcon);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyNotificationAvatarAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyMediaPlayerMaterialAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyControlCenterSliderAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_applyMediaTransportAppearance((UIView *)self);
}
%end
...
- (void)layoutSubviews {
    %orig;
    sdr_setViewSuppressed((UIView *)self, g_cowHideDeleteButtons);
}
%end
...
static char kSDRDockPinchRecognizerKey;
static char kSDRIconLabelOriginalAlphaKey;
...
static void sdr_updateDockPinchRecognizer(UIView *dockView) {
    if (!dockView) return;
    SEL action = sel_registerName("_sdrHandleDockPinch:");
    if (![dockView respondsToSelector:action]) return;
    UIPinchGestureRecognizer *pinch = objc_getAssociatedObject(dockView, &kSDRDockPinchRecognizerKey);
    if (!dockView.window || !isOnSpringBoard) {
        if (pinch.view) [pinch.view removeGestureRecognizer:pinch];
        objc_setAssociatedObject(dockView, &kSDRDockPinchRecognizerKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        return;
    }
    if (!pinch) {
        pinch = [[UIPinchGestureRecognizer alloc] initWithTarget:dockView action:action];
        objc_setAssociatedObject(dockView, &kSDRDockPinchRecognizerKey, pinch, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    if (pinch.view != dockView.window) {
        if (pinch.view) [pinch.view removeGestureRecognizer:pinch];
        [dockView.window addGestureRecognizer:pinch];
    }
    pinch.enabled = g_dockPinchControl;
}

static void sdr_refreshIconListViews(UIView *view) {
    if (!view) return;
    if ([view isKindOfClass:NSClassFromString(@"SBDockView")]) {
        sdr_updateDockPinchRecognizer(view);
    }
...
static void sdr_applyIconLabelVisibility(UIView *label) {
    if (!label) return;
    NSNumber *originalAlpha = objc_getAssociatedObject(label, &kSDRIconLabelOriginalAlphaKey);
    BOOL shouldHide = g_homeGridEnabled && g_hideHomeIconLabels;
    UIView *ancestor = label.superview;
    while (shouldHide && ancestor) {
        if ([ancestor isKindOfClass:NSClassFromString(@"SBIconView")]) {
            NSString *location = sdr_sendObjectNoArguments(ancestor, "location");
            if (location.length > 0 && [location rangeOfString:@"Root" options:NSCaseInsensitiveSearch].location == NSNotFound) {
                shouldHide = NO;
            }
            break;
        }
    ...
    if (shouldHide) {
        if (!originalAlpha) {
            objc_setAssociatedObject(label, &kSDRIconLabelOriginalAlphaKey, @(label.alpha), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        }
        label.alpha = 0.0;
        return;
    }
    if (originalAlpha) {
        label.alpha = originalAlpha.doubleValue;
        objc_setAssociatedObject(label, &kSDRIconLabelOriginalAlphaKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
}
...
- (NSUInteger)iconRowsForCurrentOrientation {
	...
	if (g_homeGridEnabled && rows >= 4) return g_homeGridRows;
	if (!g_iPadDock) return rows;
...
// ============================================================================
// 移植 FiveIconDockXI — Dock 多图标 + 捏合控制数量
// 核心:当图标列表只有一行(Dock)且捏合控制开启时,列数返回设定数量
// ============================================================================
%group FiveIconDockHooks

%hook SBIconListGridLayoutConfiguration
- (NSUInteger)numberOfPortraitColumns {
    NSUInteger original = %orig;
    NSUInteger rows = [self numberOfPortraitRows];
    if (rows == 1 && g_dockPinchControl)
        return g_dockIconCount;
    if (rows > 1 && g_homeGridEnabled)
        return g_homeGridColumns;
    return original;
}
- (NSUInteger)numberOfPortraitRows {
    NSUInteger original = %orig;
    if (original > 1 && g_homeGridEnabled)
        return g_homeGridRows;
    return original;
}
...
- (void)didMoveToWindow {
    %orig;
    sdr_updateDockPinchRecognizer((UIView *)self);
}

%new
- (void)_sdrHandleDockPinch:(UIPinchGestureRecognizer *)recognizer {
    if (!g_dockPinchControl) return;
    if (recognizer.state != UIGestureRecognizerStateEnded) return;

    // 捏合位置必须在 Dock 区域内
    CGPoint location = [recognizer locationInView:recognizer.view];
    SBDockIconListView *dockList = [[NSClassFromString(@"SBIconController") sharedInstance] dockListView];
    if (!dockList) return;
    CGRect dockFrame = [dockList convertRect:dockList.bounds toView:recognizer.view];
    if (!CGRectContainsPoint(dockFrame, location)) return;

    NSInteger newCount = g_dockIconCount;
    if (recognizer.scale > 1.08)      newCount = g_dockIconCount + 1; // 张开=增加
    else if (recognizer.scale < 0.92) newCount = g_dockIconCount - 1; // 收拢=减少
    if (newCount < kDockMinCount) newCount = kDockMinCount;
    if (newCount > kDockMaxCount) newCount = kDockMaxCount;
    if (newCount == g_dockIconCount) return;

    g_dockIconCount = newCount;
    g_dockDefaultCount = newCount;
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSMutableDictionary *domain = [[defaults persistentDomainForName:@"com.hoangdus.speedsterprefs"] mutableCopy];
    if (!domain) domain = [NSMutableDictionary dictionary];
    domain[@"dockIconCount"] = @(newCount);
    [defaults setPersistentDomain:domain forName:@"com.hoangdus.speedsterprefs"];

    // 刷新 Dock 布局(_layoutIconsNow 为私有方法,用 objc_msgSend 调用避免编译报错)
    if ([dockList respondsToSelector:@selector(_layoutIconsNow)]) {
        ((void (*)(id, SEL))objc_msgSend)(dockList, @selector(_layoutIconsNow));
    }
    [dockList setNeedsLayout];
    [dockList layoutIfNeeded];
}
%end

%end

%group HomeIconLabelHooks

%hook SBIconLabel
- (void)layoutSubviews {
    %orig;
    sdr_applyIconLabelVisibility((UIView *)self);
}
%end
...
%ctor { //More pref
    @autoreleasepool {
        ...
        if (isOnSpringBoard) {
            ...
            Class appSwitcherSettingsClass = NSClassFromString(@"SBAppSwitcherSettings");
            if (appSwitcherSettingsClass && class_getInstanceMethod(appSwitcherSettingsClass, sel_registerName("switcherStyle"))) {
            ...
            if (NSClassFromString(@"SBIconLabel")) {
                %init(HomeIconLabelHooks);
            }
            dispatch_async(dispatch_get_main_queue(), ^{
                sdr_refreshCowabungaAppearance();
                sdr_refreshSpringBoardFeatures();
        ...
        // FiveIconDock 移植 + 捏合控制数量
        // 无条件 init,由 hook 内部用 g_dockPinchControl 判断是否生效,保证开关热更新有效
        if (NSClassFromString(@"SBIconListGridLayoutConfiguration") && NSClassFromString(@"SBDockView")) {
            %init(FiveIconDockHooks);
        }
