...
static void SpeedsterLoadDockPreferences(void) {
    ...
    gDockVisibility = SpeedsterDockInteger(preferences, @"dockVisibility", 0, 0, 3);
}
...
static BOOL SpeedsterDockAllowedInApps(void) {
    return gDockVisibility == 1 || gDockVisibility == 3;
}

static BOOL SpeedsterDockAllowedInSwitcher(void) {
    return gDockVisibility == 0 || gDockVisibility == 3;
}
