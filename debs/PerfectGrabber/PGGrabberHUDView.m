...
- (void)updateContents {
    ...
    UIFont *statusFont = [UIFont monospacedDigitSystemFontOfSize:13 weight:bodyWeight];
    if (preferences.fontStyle == 2) {
        ...
        if (statusDescriptor) statusFont = [UIFont fontWithDescriptor:statusDescriptor size:13];
    }
