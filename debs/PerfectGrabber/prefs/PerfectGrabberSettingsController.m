...
- (NSMutableArray *)choiceSpecifiers {
    ...
    if ([key isEqualToString:@"AutoCloseDelay"]) {
        ...
        values = @[@0, @1, @2];
        titles = [key isEqualToString:@"GrabberStyle"]
            ? @[@"居中", @"靠左", @"靠右"]
            : @[@"常规", @"粗体", @"斜体"];
    }
...
- (NSArray *)specifiers {
    ...
    [items addObject:[self choiceLinkNamed:@"媒体卡片自动关闭" key:@"AutoCloseDelay"]];
    ...
    [footer setProperty:@"Ntonia-PreferenceLoader 1.1-12" forKey:PSFooterTextGroupKey];
