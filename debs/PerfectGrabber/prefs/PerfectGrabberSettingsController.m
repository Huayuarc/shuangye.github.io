...
- (NSArray *)specifiers {
    ...
    [items addObject:[self preferenceNamed:@"上滑时显示" key:@"ShowOnSwipeUp" defaultValue:@YES cell:PSSwitchCell]];
    ...
    [footer setProperty:@"Ntonia-PreferenceLoader 1.1-9" forKey:PSFooterTextGroupKey];
...
- (void)onResetSettings {
    NSArray *keys = @[@"EnabledPerfectGrabber", @"VibrationFeedback", @"ShowOnSwipeUp", @"Disable24H", @"ChargingIcon",
