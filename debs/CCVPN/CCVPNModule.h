...
@property(nonatomic,assign) double glyphScale;
@end
...
@class CCVPNModuleViewController;
@interface CCVPNModule : CCUIToggleModule {
    BOOL _selected;
}
@property(nonatomic,assign,getter=isSelected) BOOL selected;
@property(nonatomic,strong,readonly) CCVPNModuleViewController *contentViewController;
@property(nonatomic,strong,readonly) UIViewController *backgroundViewController;
@end

@interface CCVPNModuleViewController : CCUIToggleViewController
@end
