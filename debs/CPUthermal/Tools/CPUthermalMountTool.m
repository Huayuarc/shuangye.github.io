...
static int RestartThermalMonitor(void){pid_t pid=0;char *args[]={(char*)"killall",(char*)"-q",(char*)"thermalmonitord",NULL};int r=posix_spawnp(&pid,"killall",NULL,NULL,args,NULL);if(r)return r;} // 不 waitpid：避免阻塞守护 runloop 导致 IPC 客户端超时（返回 124）
