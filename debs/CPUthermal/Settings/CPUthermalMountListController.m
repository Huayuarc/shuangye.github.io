...
- (void)addMountPath {
 UIAlertController *a=[UIAlertController alertControllerWithTitle:S("添加挂载路径") message:S("输入 RootHide 中需要持久化的目录绝对路径。首次挂载会复制当前目录内容到隐藏根存储，并以可读写 bindfs 挂载。") preferredStyle:UIAlertControllerStyleAlert];
