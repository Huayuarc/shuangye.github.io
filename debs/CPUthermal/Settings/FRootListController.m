...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)spec {
    ...
    if ([key isEqualToString:S("force120HzEnable")] || [key isEqualToString:S("refreshThermalProtectionEnabled")]) {
        BOOL force120 = [prefs[S("force120HzEnable")] boolValue];
        id rawProtection = prefs[S("refreshThermalProtectionEnabled")];
        BOOL protection = rawProtection ? [rawProtection boolValue] : YES;
...
- (id)readPreferenceValue:(PSSpecifier *)spec {
    ...
    if ([key isEqualToString:S("refreshThermalProtectionEnabled")]) return [NSNumber numberWithBool:YES];
