...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)spec {
    ...
    if ([key isEqualToString:S("force120Hz")] || [key isEqualToString:S("refreshGlobalInjection")] || [key isEqualToString:S("refreshEnhancedMode")]) {
        CPUthermalPostRefreshRateState([prefs[S("force120Hz")] boolValue],[prefs[S("refreshGlobalInjection")] boolValue],[prefs[S("refreshEnhancedMode")] boolValue]);
    }
