...
- (void)restartThermalMonitorForModeSwitch {
    ...
    pid_t pid=0;char *args[]={(char*)"CPUthermalMountClient",(char*)"restart-thermal-monitor",NULL};
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)spec {
    ...
    if ([key isEqualToString:S("powerMode")]) {
        ...
        [self restartThermalMonitorForModeSwitch];
    } else {
