...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)spec {
    ...
    } else if ([key isEqualToString:S("killThermalStopCharging")]) {
        // 禁止系统高温停充开关 → 直接把 bit10 同步到 powerd 守护（Darwin 通知名共享）
        CPUthermalPostMitigationChargeProtect([((NSNumber *)value) boolValue]);
