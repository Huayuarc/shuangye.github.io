...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)spec {
    ...
    prefs[key] = value;
    if ([value boolValue] && [key isEqualToString:S("smartChargeEnabled")])
        prefs[S("forceFastChargeIgnoreOptimizedCharging")] = [NSNumber numberWithBool:NO];
    else if ([value boolValue] && [key isEqualToString:S("forceFastChargeIgnoreOptimizedCharging")])
        prefs[S("smartChargeEnabled")] = [NSNumber numberWithBool:NO];
