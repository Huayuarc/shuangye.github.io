...
%ctor { @autoreleasepool {
    ...
    atomic_store(&gCaptured,UIScreen.mainScreen.isCaptured); Reload();
    ...
    if(gSpringBoard)dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [gLink addToRunLoop:NSRunLoop.mainRunLoop forMode:NSRunLoopCommonModes]; Apply();
    });
} }
