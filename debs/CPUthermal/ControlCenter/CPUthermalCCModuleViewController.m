...
static const CGFloat kCPUthermalCCPreferredExpandedHeight = 300.0;   // 头部 + 3 行（标题+副标题）
...
static const CGFloat kCPUthermalCCHeaderHeight = 96.0;
static const CGFloat kCPUthermalCCMenuRowHeight = 66.0;
