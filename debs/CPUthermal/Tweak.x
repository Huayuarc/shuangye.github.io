...
CPUthermalPowerMode target = selected;
os_unfair_lock_lock(&g_modeLock);
...
if (g_restoringFullPower) { %orig(target); return; }
if (shouldApplyLowPowerLimit()) { %orig(target); return; }
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPerformancePercent); return; }
%orig(target);
}
- (void)setGPUPowerCeiling:(int)value fromDecisionSource:(uintptr_t)source {
if (g_restoringFullPower) { %orig(value,source); return; }
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPerformancePercent,source); return; }
%orig(value,source);
}
- (void)setGPUPowerFloor:(int)value fromDecisionSource:(uintptr_t)source {
if (g_restoringFullPower) { %orig(value,source); return; }
if (shouldApplyFullCPUProtection()) { %orig(shouldApplyHighPerformanceMode()?kUnrestrictedPerformancePercent:0,source); return; }
%orig(value,source);
}
- (void)setGPUPowerZoneTarget:(int)value {
if (g_restoringFullPower) { %orig(value); return; }
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPerformancePercent); return; }
%orig(value);
}
- (void)setSGXLevel:(int)value {
if (shouldApplyFullCPUProtection()) { %orig(0); return; }
%orig(value);
}
- (void)setMaxGraphicsDrivePowerTarget:(int)value {
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPowerLimitMW); return; }
%orig(value);
}
- (void)setPackagePowerBudgetDirect:(int)value withDetails:(id)details {
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPowerLimitMW,details); return; }
%orig(value,details);
}
- (void)setPackagePowerCeiling:(int)value fromDecisionSource:(uintptr_t)source {
if (g_restoringFullPower) { %orig(value,source); return; }
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPerformancePercent,source); return; }
%orig(value,source);
}
- (void)setPackagePowerFloor:(int)value fromDecisionSource:(uintptr_t)source {
if (g_restoringFullPower) { %orig(value,source); return; }
if (shouldApplyFullCPUProtection()) { %orig(shouldApplyHighPerformanceMode()?kUnrestrictedPerformancePercent:0,source); return; }
%orig(value,source);
}
...
- (void)setMaxPackagePower:(int)value {
if (shouldApplyFullCPUProtection()) { %orig(kUnrestrictedPowerLimitMW); return; }
%orig(value);
}
