...
BOOL forced;
os_unfair_lock_lock(&g_modeLock);
forced = g_foregroundAppForcesLowPower;
os_unfair_lock_unlock(&g_modeLock);
...
if (shouldApplyForegroundAppLowPowerLimit() && [controller respondsToSelector:@selector(setCPUPowerCeiling:fromDecisionSource:)])
