...
- (UIImage *)iconGlyph{UIImageSymbolConfiguration *c=[UIImageSymbolConfiguration configurationWithPointSize:36 weight:UIImageSymbolWeightMedium];return [UIImage systemImageNamed:@"video" withConfiguration:c];}- (UIImage *)selectedIconGlyph{UIImageSymbolConfiguration *c=[UIImageSymbolConfiguration configurationWithPointSize:36 weight:UIImageSymbolWeightMedium];return [UIImage systemImageNamed:@"video.fill" withConfiguration:c];}- (UIColor *)selectedColor{return [UIColor systemRedColor];}
