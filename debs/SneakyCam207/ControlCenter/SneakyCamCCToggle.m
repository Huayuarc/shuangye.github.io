...
- (UIImage *)iconGlyph{return [UIImage systemImageNamed:@"power.circle"];}- (UIImage *)selectedIconGlyph{return [UIImage systemImageNamed:@"power.circle.fill"];}- (UIColor *)selectedColor{return [UIColor systemOrangeColor];}
