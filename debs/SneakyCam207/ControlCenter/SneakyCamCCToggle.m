...
- (UIImage *)iconGlyph{UIImageSymbolConfiguration *c=[UIImageSymbolConfiguration configurationWithPointSize:36 weight:UIImageSymbolWeightMedium];return [UIImage systemImageNamed:@"power.circle" withConfiguration:c];}- (UIImage *)selectedIconGlyph{UIImageSymbolConfiguration *c=[UIImageSymbolConfiguration configurationWithPointSize:36 weight:UIImageSymbolWeightMedium];return [UIImage systemImageNamed:@"power.circle.fill" withConfiguration:c];}- (UIColor *)selectedColor{return [UIColor systemOrangeColor];}
