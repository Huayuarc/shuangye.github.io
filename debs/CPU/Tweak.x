...
static const double kLowPowerKeepAliveInterval = 0.1;  // 每0.1s秒重应用一次，缩短周期防止频率漂移
...
%orig((int)g_lowPowerMaxMHz, legacy, propertyArg);
return;
}
if (shouldApplyFullCPUProtection()) {
