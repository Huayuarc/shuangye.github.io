...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)specifier {
    ...
    } else if ([key isEqualToString:@"thermalPreventDimmingEnabled"] ||
               [key isEqualToString:@"thermalFullPowerEnabled"] ||
               [key isEqualToString:@"thermalLowPowerEnabled"]) {
        // 通知 thermalmonitord 重新加载偏好（开关变更）
        CFNotificationCenterPostNotification(
            CFNotificationCenterGetDarwinNotifyCenter(),
