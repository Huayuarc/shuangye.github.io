...
// ============================================================
// 适配: 使用 CPU 5.0.0 的偏好设置 plist 路径
// CPU thermalPrefs@2 使用的 defaults 为 com.huayuarc.cputhermal-prefs
// ============================================================
...
// ============================================================
// 适配: 通知名称，匹配 CPU 5.0.0 的 Preference Bundle
// CPUthermalPrefs.m 中发送 com.huayuarc.cputhermal-reloadPrefs
// ============================================================
...
static inline NSInteger CPUthermalNativeMaxPCoreFrequencyMHzForHardware(NSString *hardware) {
    ...
    // A18 / A18 Pro (iPhone 16 系列)
    if ([hardware isEqualToString:S("iPhone17,1")] ||
        [hardware isEqualToString:S("iPhone17,2")]) {
        return 4040;
    }
    if ([hardware isEqualToString:S("iPhone17,3")] ||
        [hardware isEqualToString:S("iPhone17,4")]) {
        return 3500;
    }
