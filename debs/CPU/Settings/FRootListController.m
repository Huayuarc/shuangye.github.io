...
static int CPUthermalNormalizedLowPowerLockMHz(int requestedMHz) {
    switch (requestedMHz) {
        case 1380:
        case 1428:
        case 1584:
...
static int CPUthermalLowPowerLockMHzFromValue(id value) {
    int rawValue = [value intValue];
    if ([value isKindOfClass:[NSNumber class]] && rawValue >= 0 && rawValue <= 3) {
        const int values[] = {1380, 1428, 1584, 2016};
