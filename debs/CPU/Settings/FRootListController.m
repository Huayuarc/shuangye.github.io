    ...
    if ([key isEqualToString:S("powerMode")]) {
        if ([value isKindOfClass:[NSNumber class]]) {
            switch ([value intValue]) {
                case 0:  value = S("off"); break;
                case 1:  value = S("lowPower"); break;
                case 2:  value = S("fullPower"); break;
                default: value = S("fullPower"); break;
            }
