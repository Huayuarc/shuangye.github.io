...
- (void)openSourceCode {
NSURL *url = [NSURL URLWithString:S("https://github.com/be-huge/insulation")];
...
[group setProperty:S("建议保持开启，避免误判温度。") forKey:S("footerText")];
[specs addObject:group];

[specs addObject:[self switchSpecifier:S("CPU温控拦截") key:S("cpuProtection")]];

// ===================== 第4组: 其他设置 =====================
group = [PSSpecifier emptyGroupSpecifier];
[group setProperty:S("其他设置") forKey:S("label")];
[specs addObject:group];
...
[specs addObject:[self buttonSpecifier:S("开源代码")
action:@selector(openSourceCode)
identifier:S("openSourceCode")]];
