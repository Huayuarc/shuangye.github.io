...
static NSDictionary *Prefs(NSString *identifier){PMPrepareAndMigrate();NSInteger n=Slot(identifier);NSMutableDictionary *m=[NSMutableDictionary dictionaryWithDictionary:PMReadDomain(LegacyID(n))];[m addEntriesFromDictionary:PMReadDomain(identifier)];return m;}
